...
from sensor.entity import TARGET_COLUMN
...
# encoding the target column 
        ...
        transformation_pipeline=get_data_transformer_object()
        ...
        utils.save_numpy_array_data(file_path=self.data_transformation_config.transformed_test_path, array=test.arr)
        ...
        data_tranformation_artifact=artifact_entity.DataTransformationArtiFact(tranform_object_path=self.data_transformation_config.tranform_object_path,transformed_train_path=self.data_transformation_config.transformed_train_path,
        transformed_test_path=self.data_transformation_config.transformed_test_path,target_encoder_path=self.data_transformation_config.target_encoder_path)
